...
func (p *CalendarProvider) Descriptor() core.CapabilityDescriptor {
	return core.CapabilityDescriptor{Name: "calendar", DisplayName: "Calendar", Description: "Linux calendar provider skeleton.", Commands: []string{"calendar.events", "calendar.add"}, Tier: 2}
}
