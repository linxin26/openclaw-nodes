...
func (p *NotificationsProvider) Descriptor() core.CapabilityDescriptor {
	return core.CapabilityDescriptor{Name: "notifications", DisplayName: "Notifications", Description: "Linux notifications provider skeleton.", Commands: []string{"notifications.list", "notifications.actions"}, Tier: 2}
}
